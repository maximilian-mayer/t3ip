...
tt_content.image.20 {
	...
	#
	imageStdWrap.dataWrap = <figure class="csc-textpic-imagewrap"> | </figure>
	imageStdWrapNoWidth.wrap = <figure class="csc-textpic-imagewrap"> | </figure>

	# if noRows is set, wrap around each column:
	imageColumnStdWrap.dataWrap = <div class="csc-textpic-imagecolumn norows"> | </div>
	...
	rendering {
		...
		noCaption {
			...
			lastRowStdWrap.wrap = |
			columnStdWrap.wrap = <figure class="csc-textpic-imagecolumn###CLASSES###"> | </figure>
		}
		singleCaption {
